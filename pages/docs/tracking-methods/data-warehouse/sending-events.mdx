...
7. Specify the Event Time:
    - This is the time the event occurred. Mixpanel recommends an iso-formatted date string (YYYY-MM-DDTHH:mm:ss), and you should send this Event Time to Mixpanel as Coordinated Universal Time (UTC) to ensure it displays correctly in your project.
